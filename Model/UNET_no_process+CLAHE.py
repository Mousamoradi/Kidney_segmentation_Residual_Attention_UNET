...
csv_logger = CSVLogger(r'C:\Users\MOUSAMORADI\Desktop\newtry\log\unet_no_process_{}.log'.format(datetime.now().strftime("%Y_%m_%d-%H_%M")))
...
callbacks = [ModelCheckpoint('unet_no_process1.hdf5', verbose=1, save_best_only=True), csv_logger]
...
model = load_model('unet_no_process.hdf5', custom_objects={'dice_coef_loss': dice_coef_loss, 'iou': iou, 'dice_coef': dice_coef})
# Testing the results
